      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          >
            ...
            <h3 className="text-xl font-bold tracking-tight mb-2">Job Interview</h3>
            <p className="text-white/40 text-sm mb-4">Comprehensive interview simulation</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold tracking-tight mb-2">Strategic Case</h3>
            <p className="text-white/40 text-sm mb-4">Consulting-style case study</p>
          ...
          >
            ...
            <h3 className="text-xl font-bold tracking-tight mb-2">Annual Review</h3>
            <p className="text-white/40 text-sm mb-4">Performance review preparation</p>
